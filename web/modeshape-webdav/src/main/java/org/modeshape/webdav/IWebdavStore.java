...
public interface IWebdavStore {
     ...
     * been started. The request will be terminated by either {@link #commit(ITransaction)}
     ...
     * @param characterEncoding character encoding of the resource or <code>null</code> if unknown
     * or not applicable
