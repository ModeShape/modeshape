...
public class DoLock extends AbstractMethod {
    ...
    public void execute( ITransaction transaction,
        ...
        if (_readOnly) {
            ...
            if (!isUnlocked(transaction, req, resp, _resourceLocks, _path)) {
                resp.setStatus(WebdavStatus.SC_LOCKED);
                return; // resource is locked
            }

            if (!isUnlocked(transaction, req, resp, _resourceLocks, _parentPath)) {
                resp.setStatus(WebdavStatus.SC_LOCKED);
     ...
     */
    private int getTimeout( ITransaction transaction,
                            HttpServletRequest req ) {
    ...
    private void generateXMLReport( ITransaction transaction,
                                    ...
                                    LockedObject lo ) throws IOException {
