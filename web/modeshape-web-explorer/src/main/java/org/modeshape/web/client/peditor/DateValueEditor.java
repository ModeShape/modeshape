...
public class DateValueEditor extends BaseEditor implements ValueEditor<String> {
    ...
    //form fields
    private final DateTimeItem valueEditor = new DateTimeItem("Value");
     ...
     */
    public DateValueEditor(Contents contents) {
    ...
    public void onConfirm(ClickEvent event) {
        contents.setNodeProperty(node, name, valueEditor.getValueAsDate());
    }
