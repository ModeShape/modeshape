...
public class Contents extends VLayout {
    ...
    public void changeWorkspace(final String name) {
        show(repository(), name, ROOT_PATH, true);
        updateControls();
    }
...
//        console.display(Contents.this);
    ...
    public void removeNode() {
        ...
        console.jcrService().removeNode(repository(), workspace(), path(), new AsyncCallback<Object>() {
            @Override
            public void onFailure(Throwable caught) {
                SC.say(caught.getMessage());
            }
    ...
    protected void renameNode(String name) {
        console.jcrService().renameNode(repository(), workspace(), path(), name, new AsyncCallback<Object>() {
            @Override
            public void onFailure(Throwable caught) {
                SC.say(caught.getMessage());
            }
