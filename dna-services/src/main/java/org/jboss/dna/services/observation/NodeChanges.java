        ...
        for (Event event : events) {
            ...
            if (eventType == Event.PROPERTY_ADDED || eventType == Event.PROPERTY_CHANGED || eventType == Event.PROPERTY_REMOVED) {
                ...
                if (lastDelim < 1 || lastDelim == (eventPath.length() - 1)) {
                    ...
                    I18n msg =
                        eventType == Event.PROPERTY_ADDED ? ServicesI18n.errorFindingPropertyNameInPropertyAddedEvent : eventType == Event.PROPERTY_CHANGED ? ServicesI18n.errorFindingPropertyNameInPropertyChangedEvent : ServicesI18n.errorFindingPropertyNameInPropertyRemovedEvent;
