 ...
 * This interface does take advantage of the variable arguments and autoboxing features
 * in Java 5, reducing the number of methods that are necessary and allowing callers
...
public class Logger {
	 ...
	 * message.
	 * If the exception is null, then this method calls {@link #debug(String, Object...)}.
	 * 
	 ...
	 * message.
	 * If the exception is null, then this method calls {@link #error(String, Object...)}.
	 * 
	 * @param t the exception (throwable) to log
	 * @param message the message accompanying the exception
	 * @param params the parameter values that are to replace the variables in the format string
	 ...
	 * message.
	 * If the exception is null, then this method calls {@link #info(String, Object...)}.
	 * 
	 * @param t the exception (throwable) to log
	 * @param message the message accompanying the exception
	 * @param params the parameter values that are to replace the variables in the format string
	 ...
	 * message.
	 * If the exception is null, then this method calls {@link #trace(String, Object...)}.
	 * 
	 * @param t the exception (throwable) to log
	 * @param message the message accompanying the exception
	 * @param params the parameter values that are to replace the variables in the format string
	 ...
	 * message. 
	 * If the exception is null, then this method calls {@link #warn(String, Object...)}.
	 * 
	 * @param t the exception (throwable) to log
	 * @param message the message accompanying the exception
	 * @param params the parameter values that are to replace the variables in the format string
	 ...
	 * @return true if INFORMATION log messages are currently being logged, 
	 * or false otherwise.
	 */
	 ...
	 * @return true if WARNING log messages are currently being logged, 
	 * or false otherwise.
	 */
	 ...
	 * @return true if ERROR log messages are currently being logged, 
	 * or false otherwise.
	 */
	 ...
	 * @return true if DEBUG log messages are currently being logged, 
	 * or false otherwise.
	 */
	 ...
	 * @return true if TRACE log messages are currently being logged, 
	 * or false otherwise.
	 */
