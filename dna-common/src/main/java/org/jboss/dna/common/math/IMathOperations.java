 ...
 * This is useful for generic classes that must work with one of the {@link Number}
 * subclasses.
 * @param <T> the numeric class, usually a subclass of {@link Number}
...
public interface IMathOperations<T> {
	 ...
	 * The {@link #createZeroValue() zero value} is used in place of any operand that is null.
	...
	/**
	 * Increment the supplied operand by 1.  (Note, the exact meaning of "1" is dependent
	 * upon the particular {@link #getOperandClass() operand class}.
	 * The {@link #createZeroValue() zero value} is used in place of any operand that is null.
	 ...
	 * A null value is considered smaller than non-null values (including 0).
	 * @param value1 the first operand
	 * @param value2 the second operand
	 ...
	 * A null value is considered larger than non-null values (including 0).
	 * @param value1 the first operand
	 * @param value2 the second operand
	...
	/**
	 * Compare the two operands and return an integer that describes whether the first
	 * value is larger, smaller or the same as the second value.  The semantics are
	 * identical to those of {@link Comparable}.
	 * The {@link #createZeroValue() zero value} is used in place of any operand that is null.
	 * @param value1 the first operand
	 * @param value2 the second operand
	 * @return -1 if the first value is smaller than the second, 1 if the first value is
	 * larger than the second, or 0 if they are equal.
	 */
	...
	/**
	 * Convert the {@link BigDecimal} representation into the natural object representation.
	 * This may result in loss of some data (e.g., converting a decimal to an integer
	 * results in the loss of the fractional part of the number).
	...
	/**
	 * Convert the value to a double.  This may result in a loss of information depending upon
	 * the {@link #getOperandClass() operand class}.
	...
	/**
	 * Convert the value to a float.  This may result in a loss of information depending upon
	 * the {@link #getOperandClass() operand class}.
	 * @param value the value
	...
	/**
	 * Convert the value to an integer.  This may result in a loss of information depending upon
	 * the {@link #getOperandClass() operand class}.
	 * @param value the value
	...
	/**
	 * Convert the value to a short.  This may result in a loss of information depending upon
	 * the {@link #getOperandClass() operand class}.
	 * @param value the value
	...
	/**
	 * Convert the value to a long integer.  This may result in a loss of information depending upon
	 * the {@link #getOperandClass() operand class}.
	 * @param value the value
	...
	/**
	 * Create the object form of the "zero value".  This is often used to create
	...
	/**
	 * Return a {@link Comparator Comparator<T>} for this {@link #getOperandClass() operand class}.
	 * The implementation is free to return the same comparator instance from multiple invocations of this method.
	 * @return a comparator
	 */
	...
	/**
	 * Round up the supplied value to the desired scale.  This process works (conceptually) by shifting
	 * the decimal point of the value by <code>decimalShift</code> places, rounding, and then
	 * shifting the decimal point of the rounded value by <code>-decimalShift</code>
	 * <p>
	 * For example, consider the number 10.000354.  This can be rounded to 10.0004 by calling this
	 * method and supplying the value and an "exponentToKeep" value of -4.
	 * </p>
	...
	/**
	 * Round down the supplied value to the desired scale.  This process works (conceptually) by shifting
	 * the decimal point of the value by <code>decimalShift</code> places, rounding, and then
	 * shifting the decimal point of the rounded value by <code>-decimalShift</code>
	 * <p>
	 * For example, consider the number 10.000354.  This can be rounded to 10.0003 by calling this
	 * method and supplying the value and an "exponentToKeep" value of -4.
	 * </p>
	 * @param value the value to be rounded
	 * @param decimalShift the number of places the decimal point should be shifted before rounding
	 ...
	 * @return an instance of the {@link #getOperandClass() operand class} placed within the desired range using a random distribution,
	 * or null if this class does not support generating random instances
	 */
