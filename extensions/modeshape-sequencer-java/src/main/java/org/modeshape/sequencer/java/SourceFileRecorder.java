 ...
 * </p>
 * <p>
 * To use, supply the implementation class name to a {@link JavaMetadataSequencer} object. Each instance will be reused for
 * multiple {@link JavaMetadataSequencer#sequence(java.io.InputStream, SequencerOutput, StreamSequencerContext) sequence calls} ,
...
public interface SourceFileRecorder {
    ...
    /**
     * Records a source file using the provided {@link SequencerOutput} instance.
     * 
