...
public class PortTypeResolvers {
    ...
    private final Map<String, NamespaceEntityResolver> resolversByKind = new HashMap<String, NamespaceEntityResolver>();

    public NamespaceEntityResolver get( String portTypeName ) {
