...
/**
 * A configuration for a {@link TextExtractor} component.
 */
@Immutable
public class TextExtractorConfig extends ComponentConfig {

    public TextExtractorConfig( String name,
                                String description,
    ...
    public TextExtractorConfig( String name,
                                String description,
                                Map<String, Object> properties,
                                Class<? extends TextExtractor> clazz ) {
