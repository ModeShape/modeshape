...
public abstract class Logger {
    ...
    /**
     * Return a logger named corresponding to the class passed as parameter, using the statically bound {@link #LOG_FACTORY}
     * instance.
     * 
    ...
    /**
     * Return a logger named according to the name parameter using the statically bound {@link #LOG_FACTORY} instance.
     * 
