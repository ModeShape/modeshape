...
class JcrStatement implements Statement {
    ...
    public boolean execute( String sql,
                            int autoGeneratedKeys ) throws SQLException {
        return execute(sql); // ignore the autoGeneratedKeys because we don't support INSERT statements
    }
    ...
    public boolean execute( String sql,
                            int[] columnIndexes ) throws SQLException {
        return execute(sql); // ignore the columnIndexes because we don't support INSERT statements
    }
    ...
    public boolean execute( String sql,
                            String[] columnNames ) throws SQLException {
        return execute(sql); // ignore the columnNames because we don't support INSERT statements
    }
