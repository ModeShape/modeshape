...
public class JcrMetaDataTeiidSupportTest extends ResultsComparator {
    ...
    public void beforeEach() throws RepositoryException {
        ...
        when(connInfo.isTeiidSupport()).thenReturn(true);
    ...
    protected static URL resourceUrl( String name ) {
        return JcrMetaDataTeiidSupportTest.class.getClassLoader().getResource(name);
    }

    protected static InputStream resourceStream( String name ) {
        return JcrMetaDataTeiidSupportTest.class.getClassLoader().getResourceAsStream(name);
    }
