...
public class JcrDriverHttpIntegrationTest extends ConnectionResultsComparator {
    ...
    private String url = JcrDriver.HTTP_URL_PREFIX + serverName + "/resources/" + repositoryName + "/" + workspaceName
                         + "?username=dnauser&password=password";
    ...
    public void shouldGetCatalogs() throws SQLException {
        ...
        String[] expected = {"TABLE_CAT[String]", "mode:repository"};
