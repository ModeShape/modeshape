...
public class JcrDriverIntegrationTest extends ConnectionResultsComparator {
    ...
    private static String validUrl = LocalJcrDriver.JNDI_URL_PREFIX + jndiNameForRepository + "?repositoryName=cars";
    private LocalJcrDriver.JcrContextFactory contextFactory;
    ...
    public void beforeEach() throws Exception {
        ...
        contextFactory = new LocalJcrDriver.JcrContextFactory() {
