 ...
 * <li><strong>2002-04-10</strong> Fixed a bug in the feature 'determine number of images in animated GIF' introduced with version
 * 1.1. Thanks to Marcelo P. Lima for sending in the bug report. Released as 1.1.1.</li>
 ...
 * <li><strong>2003-07-28</strong> Bug fix - skip method now takes return values into consideration. Less bytes than necessary may
 ...
 * data streams. Thanks to Martin Leidig for reporting this and sending in code. Released as 1.8.</li> </li>
 ...
 * Released as 1.9.</li>
 * <li><strong>2008-04-10</strong> Changed comment vector to be <code>Vector&lt;String&gt;</code>, and removed any unnecessary
...
public class ImageMetadata {
    ...
    /**
     * If {@link #check()} was successful and {@link #setCollectComments(boolean)} was called with <code>true</code> as argument,
    ...
    /**
     * Returns the physical width of an image in inches, or <code>-1.0f</code> if width information is not available. Assumes that
