...
/**
 * Tests of round-trip importing/exporting of repository content for persistent infinispan.
 */
public class ImportExportPersistentTest extends ImportExportTest {
    ...
    public void startRepository() throws Exception{
    	 InputStream configInputStream = getClass().getClassLoader().getResourceAsStream("config/repo-h2.json");
