...
/**
 * The {@code JndiManagedRepositoryFactory} class provides a means of initializing and accessing {@link Repository repositories} in a
 ...
 *           factory=&quot;org.modeshape.jcr.JndiManagedRepositoryFactory&quot;
 ...
 * </p>
 */
public class JndiManagedRepositoryFactory implements ObjectFactory {
    ...
    protected static final Logger log = Logger.getLogger(JndiManagedRepositoryFactory.class);
