...
public final class IndexPlan implements Comparable<IndexPlan> {
     ...
     * higher cost than another index that is less expensive to use. For example, if a {@link QueryIndexProvider} that owns the
    ...
    @Immutable
    public static class StandardIndexPlanner extends QueryIndexPlanner {
        public static final QueryIndexPlanner INSTANCE = new StandardIndexPlanner();
        ...
        public void applyIndexes( QueryContext context,
            ...
            for (javax.jcr.query.qom.Constraint constraint : andedConstraints) {
                if (constraint instanceof SameNode) {
                    ...
                    indexes.addIndex(DESCENDANTS_BY_PATH_INDEX_NAME,
                                     null,
                    ...
                    if (leftSide instanceof NodePath) {
                        ...
                        if (path != null) {
                            indexes.addIndex(NODE_BY_PATH_INDEX_NAME,
                                             null,
                                             singletonList(constraint),
                                             1,
                                             1L,
