...
public class NodeTypes {
     ...
     */
    private final List<ReusableNodeDefinitionSet> standardNodeDefinitionSets = new LinkedList<ReusableNodeDefinitionSet>();
    ...
    private final Set<Name> nodeTypeNamesThatAreShareable = new HashSet<Name>();

    private final Set<Name> nodeTypeNamesWithNoChildNodeDefns = new HashSet<Name>();
    ...
    private final class MatchResults {
        ...
        private final Set<JcrNodeDefinition> recorded = new HashSet<JcrNodeDefinition>();
