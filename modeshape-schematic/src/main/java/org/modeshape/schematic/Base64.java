...
public class Base64 {
    ...
    public static String encode( java.io.InputStream source,
        ...
        try {
            ...
            error = true;
            throw new RuntimeException(e); // error using reading from byte array!
        } finally {
            try {
                input.close();
            } catch (IOException e) {
                if (!error) new RuntimeException(e); // error closing input stream
            }
        }
     ...
     * @return decoded data
     * @throws java.io.IOException if there is an error decoding the supplied byte array
     * @since 2.3.1
     */
    ...
    public static byte[] decodeFromFile( String filename ) throws IOException {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new java.io.FileInputStream(file)), Base64.DECODE);
    ...
    public static String encodeFromFile( String filename ) throws IOException {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64.InputStream(new BufferedInputStream(new java.io.FileInputStream(file)), Base64.ENCODE);
