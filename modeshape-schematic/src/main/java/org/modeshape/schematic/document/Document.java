...
public interface Document extends Serializable {
    ...
    /**
     * Get the {@link Bson.Type} constant that describes the type of value for the given field name.
     * 
     * @param name The name of the pair
     * @return the {@link Bson.Type} constant describing the value, or -1 if there is no field with the supplied name
     */
