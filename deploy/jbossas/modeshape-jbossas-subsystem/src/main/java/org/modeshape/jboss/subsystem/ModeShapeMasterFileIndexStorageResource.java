...
public class ModeShapeMasterFileIndexStorageResource extends SimpleResourceDefinition {
    ...
    private ModeShapeMasterFileIndexStorageResource() {
        super(ModeShapeExtension.MASTER_FILE_STORAGE_PATH,
    ...
    public void registerAttributes(ManagementResourceRegistration resourceRegistration) {
        ...
        IndexStorageWriteAttributeHandler.MASTER_FILE_STORAGE_INSTANCE.registerAttributes(resourceRegistration);
    }
}
