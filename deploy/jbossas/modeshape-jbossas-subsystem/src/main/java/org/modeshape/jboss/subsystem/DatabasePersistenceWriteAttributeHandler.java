 ...
 */
public class DatabasePersistenceWriteAttributeHandler extends AbstractRepositoryConfigWriteAttributeHandler {

    static final DatabasePersistenceWriteAttributeHandler INSTANCE = new DatabasePersistenceWriteAttributeHandler();

    private DatabasePersistenceWriteAttributeHandler() {
        super(ModelAttributes.PERSISTENCE_DB_ATTRIBUTES);
    }
