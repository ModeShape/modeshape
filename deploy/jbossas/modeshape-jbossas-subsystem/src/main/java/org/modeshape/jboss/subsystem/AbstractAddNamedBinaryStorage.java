...
public abstract class AbstractAddNamedBinaryStorage extends AbstractAddStepHandler {

    protected AbstractAddNamedBinaryStorage() {
    }
    ...
    protected void performRuntime( final OperationContext context,
        ...
        ServiceName namedServiceName = ModeShapeServiceNames.binaryStorageServiceName(repositoryName, binaries.getString(FieldName.BINARY_STORE_NAME));
        context.removeService(namedServiceName);

        // Now create the new service ...
        BinaryStorageService service = new BinaryStorageService(repositoryName, binaries);

        ServiceBuilder<BinaryStorage> builder = target.addService(namedServiceName, service);
        ...
        AddCompositeBinaryStorage.INSTANCE.writeNamedBinaryStore(storeName, binaries);

        AddCompositeBinaryStorage.INSTANCE.updateConfigurationOnBinaryStoreChange(context, operation, newControllers);
    }
    ...
    protected void writeCommonBinaryStorageConfiguration( OperationContext context,
        ...
        binaries.set(FieldName.BINARY_STORE_NAME, storeName);
    }
