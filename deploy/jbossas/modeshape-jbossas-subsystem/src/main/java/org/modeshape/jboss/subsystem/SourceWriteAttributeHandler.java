 ...
 * source's submodel.
 * {@link org.jboss.as.controller.AttributeDefinition attribute definitions}. Those attributes that can be changed
 ...
 */
public class SourceWriteAttributeHandler extends AbstractRepositoryConfigWriteAttributeHandler {

    static final SourceWriteAttributeHandler INSTANCE = new SourceWriteAttributeHandler();

    private SourceWriteAttributeHandler() {
        super(ModelAttributes.SOURCE_ATTRIBUTES);
    }
    ...
    protected boolean changeField( OperationContext context,
        ...
        String sourceName = sourceName(operation);
        repositoryService.changeSourceField(defn, newValue, sourceName);
        return true;
    }
