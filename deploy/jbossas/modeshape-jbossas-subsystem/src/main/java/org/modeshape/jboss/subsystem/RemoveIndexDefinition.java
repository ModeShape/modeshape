...
class RemoveIndexDefinition extends AbstractModeShapeRemoveStepHandler {

    static final RemoveIndexDefinition INSTANCE = new RemoveIndexDefinition();

    private RemoveIndexDefinition() {
    }
