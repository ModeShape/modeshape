...
import org.modeshape.jboss.ModeShapeExtension;
...
public class TestModeShapeConfiguration extends AbstractSubsystemTest {
    ...
    public void testDescribeHandler() throws Exception {
        ...
        describeOp.get(OP_ADDR).set(PathAddress.pathAddress(PathElement.pathElement(SUBSYSTEM, ModeShapeExtension.MODESHAPE_SUBSYSTEM)).toModelNode());
