...
public class RelationalProvider implements SchematicDbProvider<RelationalDb> {
    ...
    protected static final String ALIAS1 = "db";
    protected static final String ALIAS2 = "database";
    
    private static final List<String> ALIASES = Arrays.asList(ALIAS1, ALIAS2);
    
    @Override
    public RelationalDb getDB(String type, Document configuration) {
        if (!ALIASES.contains(type.toLowerCase())) {
            return null;
        }
